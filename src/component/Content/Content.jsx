    ...
    <div>
      <div className="my-3">
        ...
        <div className="text-left">
          <p className="text-gray-700 mt-3 font-semibold">Meaning</p>
          <ul className="list-disc px-10 text-gray-700 text-sm space-y-2">
            {definitions.map((def, index) => (
              <li key={index}>{def.definition}</li>
            ))}
          </ul>
          <p className="text-gray-800 mt-6 font-semibold">Example</p>
          <ul className="list-disc px-10 mt-2 text-gray-700 text-sm space-y-2">
